...
// SAME name/email is still a BLOCK if it appears anywhere else, and CPR/IBAN-style
// PII is still caught even inside the legal block. Fail-closed: if the legal block
// can't be located the whole file is scanned unmodified (a moved/renamed block
